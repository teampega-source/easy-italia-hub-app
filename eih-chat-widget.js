...
(function(){
  ...
  function toggleChat(){
    ...
    if(open){setChatUnread(0);setTimeout(function(){var i=document.getElementById('ch-in');if(i)i.focus();},300);}
  }

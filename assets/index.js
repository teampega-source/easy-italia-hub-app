...
const I18N={
  it:{
    ...
    "eo.title":"Cosa ti serve oggi?","eo.1":"Il permesso sta scadendo","eo.2":"Cerco casa","eo.3":"Cerco lavoro","eo.4":"Voglio imparare l'italiano","eo.5":"Devo mandare soldi a casa","eo.6":"Non capisco una lettera",
    ...
    "chat.ainoteShort":"Risposte generate da un'AI: informazioni generali, non consulenza legale.","chat.ainote":"L'Intelligenza Artificiale fornisce informazioni generali basate su fonti pubbliche. Non sostituisce in alcun modo la consulenza legale di un avvocato, di un Patronato o di un CAF autorizzato. Easy Italia Hub declina ogni responsabilità per errori o per l'uso improprio delle informazioni.","chat.name":"Assistente Easy Italia","chat.status":"Assistente automatico","chat.welcome1":"Ciao! Sono un assistente virtuale di Easy Italia Hub: le risposte sono generate da un'intelligenza artificiale. Come posso aiutarti oggi?","chat.welcome2":"Posso risponderti in italiano, inglese, <span lang=\"si\">සිංහල</span> o <span lang=\"ta\">தமிழ்</span>.","chat.now":"Ora","chat.sug1":"Permesso di soggiorno","chat.sug2":"SPID","chat.sug3":"Money transfer","chat.sug4":"Codice fiscale","chat.placeholder":"Scrivi un messaggio…","chat.q1":"Come si rinnova il permesso di soggiorno?","chat.q2":"Come si ottiene lo SPID?","chat.q3":"Come funziona il money transfer verso lo Sri Lanka?","chat.q4":"Come si richiede il codice fiscale?",
  ...
  en:{
    ...
    "eo.title":"What do you need today?","eo.1":"My permit is expiring","eo.2":"I'm looking for a home","eo.3":"I'm looking for a job","eo.4":"I want to learn Italian","eo.5":"I need to send money home","eo.6":"I don't understand a letter",
  ...
  si:{
    ...
    "eo.title":"ඔබට අද අවශ්‍ය කුමක්ද?","eo.1":"මගේ බලපත්‍රය කල් ඉකුත් වෙමින්","eo.2":"මම නිවසක් සොයමි","eo.3":"මම රැකියාවක් සොයමි","eo.4":"මට ඉතාලි ඉගෙන ගන්න ඕන","eo.5":"මට ගෙදරට සල්ලි යවන්න ඕන","eo.6":"මට ලිපියක් තේරෙන්නේ නැහැ",
  ...
  ,ta:{
    ...
    "eo.title":"இன்று உங்களுக்கு என்ன தேவை?","eo.1":"என் அனுமதி முடிவடைகிறது","eo.2":"நான் வீடு தேடுகிறேன்","eo.3":"நான் வேலை தேடுகிறேன்","eo.4":"நான் இத்தாலியம் கற்க விரும்புகிறேன்","eo.5":"வீட்டிற்குப் பணம் அனுப்ப வேண்டும்","eo.6":"எனக்கு கடிதம் புரியவில்லை",
...
/* Barra partner. Finché i loghi ci stanno nella riga restano fermi e centrati:
   un solo logo che scorre in tondo sembra una barra rotta, non una vetrina.
   Quando non ci stanno più, la fila si duplica e parte l'animazione — che è
   anche il motivo per cui l'animazione arriva a -50%: scorre la prima copia
   e la seconda le va dietro senza salti. */
(function(){
  const barraPartner=()=>{
    const t=document.getElementById('pt-track');
    if(!t)return;
    const bar=t.parentElement;
    const figli=Array.from(t.children);
    if(!figli.length||bar.classList.contains('is-scroll'))return;
    // A capo la riga non straborda mai: la larghezza naturale va sommata a mano.
    const gap=parseFloat(getComputedStyle(t).columnGap)||0;
    const largo=figli.reduce((w,n)=>w+n.offsetWidth,0)+gap*(figli.length-1);
    if(largo<=bar.clientWidth+8)return;
    figli.forEach(n=>{
  ...
  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',barraPartner,{once:true});
  else barraPartner();
})();
...
(function(){
  ...
  const targets=[...document.querySelectorAll('.ad-mini-bar,.donate-card,.cta-card,.footer-brand,.footer-col,.svc-card,.plan,.tools-section .section-label,.tools-section .section-title,.tools-section .section-sub,.tw-group,.does-section .section-label,.does-section .section-title,.does-section .section-sub,.does-card,.ct-foto')];

...
(function () {
  ...
  var css =
    ...
    '#eihp-fab::before{content:"";position:absolute;inset:-3px;border-radius:50%;border:2px solid rgba(235,89,57,.5);opacity:0;pointer-events:none;animation:eihp-ring 3.6s ease-out infinite}' +

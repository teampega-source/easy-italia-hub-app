...
(function () {
  ...
  var css =
    '#eihp-fab{position:fixed;left:18px;bottom:18px;width:46px;height:46px;border-radius:50%;border:1px solid rgba(118,118,118,.3);' +
    ...
    '@media(max-width:640px){#eihp-fab{bottom:84px}}';

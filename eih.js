...
(function(){
  const I18N={
    it:{"f.langHint":"Anche l\u2019assistente AI ti risponde in italiano.", "nav.guide":"Guide","nav.community":"Community","nav.courses":"Corsi","nav.journey":"Percorso","nav.news":"News","nav.map":"Mappa","nav.contact":"Contatti","nav.login":"Accedi","nav.signup":"Registrati",
      ...
      "f.product":"Prodotto","f.aiAssistant":"Assistente AI","f.mapServices":"Mappa servizi","f.company":"Il progetto","f.about":"Chi siamo","f.rete":"Rete & Affiliazioni","f.whatsapp":"Canale WhatsApp","f.advertising":"Sponsorizza","f.contact":"Contatti","f.account":"Account","f.register":"Registrati","f.subscriptions":"Abbonamenti","f.copy":"© 2026 Easy Italia Hub. Tutti i diritti riservati.","f.privacy":"Privacy Policy","f.cookie":"Cookie Policy","f.terms":"Termini di Servizio","f.legal":"Note legali","f.cookieprefs":"Preferenze cookie" },
    en:{"f.langHint":"The AI assistant replies in English too.", "nav.guide":"Guides","nav.community":"Community","nav.courses":"Courses","nav.journey":"Journey","nav.news":"News","nav.map":"Map","nav.contact":"Contact","nav.login":"Log in","nav.signup":"Sign up",
      ...
      "f.product":"Product","f.aiAssistant":"AI Assistant","f.mapServices":"Services map","f.company":"The project","f.about":"About us","f.rete":"Network & Partners","f.whatsapp":"WhatsApp channel","f.advertising":"Sponsor us","f.contact":"Contact","f.account":"Account","f.register":"Register","f.subscriptions":"Subscriptions","f.copy":"© 2026 Easy Italia Hub. All rights reserved.","f.privacy":"Privacy Policy","f.cookie":"Cookie Policy","f.terms":"Terms of Service","f.legal":"Legal notice","f.cookieprefs":"Cookie preferences" },

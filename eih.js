...
(function(){
  const I18N={
    it:{"f.langHint":"Anche l\u2019assistente AI ti risponde in italiano.", "nav.guide":"Guide","nav.community":"Community","nav.courses":"Corsi","nav.journey":"Il Mio Percorso","nav.news":"News","nav.map":"Mappa","nav.contact":"Contattaci","nav.login":"Accedi","nav.signup":"Registrati gratis",
    ...
    en:{"f.langHint":"The AI assistant replies in English too.", "nav.guide":"Guides","nav.community":"Community","nav.courses":"Courses","nav.journey":"My Journey","nav.news":"News","nav.map":"Map","nav.contact":"Contact us","nav.login":"Log in","nav.signup":"Sign up free",
      ...
      "nav.academy":"Easy Italia Academy","nav.services":"Services","m.forum":"Forum","m.academy":"Academy lessons","m.certprep":"Certification prep","m.aiteacher":"AI Teacher","m.school":"School & study","m.market":"Marketplace","m.translate":"Translations","m.housing":"Housing","m.pros":"Professionals","m.quicknav":"Quick navigation","m.flights":"Sri Lanka Flights","m.languages":"Language Courses","m.esame":"Exam & Badge","m.opportunities":"Opportunities","m.cargo":"Cargo Shipping","m.templates":"Forms & Letters","m.openaccount":"Open a Bank Account","m.assegno":"Assegno Unico Calc.","m.inps":"INPS Rights Check","m.titles":"Qual. Recognition","m.medical":"Medical Dictionary","m.dashboard":"My Dashboard","m.tracker":"Permit Tracker","m.docs":"Document Archive","m.cvbuilder":"CV Builder",
    ...
    si:{"f.langHint":"AI සහායකයාද සිංහලෙන් පිළිතුරු දෙයි.", "nav.guide":"මාර්ගෝපදේශ","nav.community":"ප්‍රජාව","nav.courses":"පාඨමාලා","nav.journey":"මගේ ගමන","nav.news":"පුවත්","nav.map":"සිතියම","nav.contact":"අපව අමතන්න","nav.login":"පිවිසෙන්න","nav.signup":"නොමිලේ ලියාපදිංචි වන්න",
      ...
      "nav.academy":"Easy Italia Academy","nav.services":"සේවා","m.forum":"සංසදය","m.academy":"Academy පාඩම්","m.certprep":"සහතික සූදානම","m.aiteacher":"AI ගුරු","m.school":"පාසල හා අධ්‍යාපනය","m.market":"වෙළඳපොළ","m.translate":"පරිවර්තන","m.housing":"නිවාස","m.pros":"වෘත්තිකයන්","m.quicknav":"ඉක්මන් සොයන","m.flights":"ශ්‍රී ලංකා ගුවන් ගමන්","m.languages":"භාෂා පාඨමාලා","m.esame":"විභාගය සහ බැජ්","m.opportunities":"අවස්ථා","m.cargo":"ගෙවල් ගෙනයාම","m.templates":"ෆෝරම් සහ ලිපි","m.openaccount":"බැංකු ගිණුමක්","m.assegno":"Assegno Unico ගණකය","m.inps":"INPS අයිතිවාසිකම්","m.titles":"සුදුස්සකම් හඳුනාගැනීම","m.medical":"වෛද්‍ය ශබ්දකෝෂය","m.dashboard":"මගේ ඩෑෂ්බෝඩ්","m.tracker":"බලපත්‍ර ලුහුබැඳීම","m.docs":"ලේඛනාගාරය","m.cvbuilder":"CV Builder",
    ...
    ta:{"f.langHint":"AI உதவியாளரும் தமிழில் பதிலளிக்கும்.", "nav.guide":"வழிகாட்டிகள்","nav.community":"சமூகம்","nav.courses":"படிப்புகள்","nav.journey":"என் பயணம்","nav.news":"செய்திகள்","nav.map":"வரைபடம்","nav.contact":"தொடர்பு கொள்ளுங்கள்","nav.login":"உள்நுழைய","nav.signup":"இலவசமாக பதிவு",
      ...
      "nav.academy":"Easy Italia Academy","nav.services":"சேவைகள்","m.forum":"மன்றம்","m.academy":"Academy பாடங்கள்","m.certprep":"சான்றிதழ் தயாரிப்பு","m.aiteacher":"AI ஆசிரியர்","m.school":"பள்ளி & படிப்பு","m.market":"சந்தை","m.translate":"மொழிபெயர்ப்புகள்","m.housing":"வீடு","m.pros":"நிபுணர்கள்","m.quicknav":"விரைவு வழிசெலுத்தல்","m.flights":"இலங்கை விமானங்கள்","m.languages":"மொழி வகுப்புகள்","m.esame":"தேர்வு & பேட்ஜ்","m.opportunities":"வாய்ப்புகள்","m.cargo":"சரக்கு அனுப்புதல்","m.templates":"படிவங்கள் & கடிதங்கள்","m.openaccount":"வங்கி கணக்கு திறக்க","m.assegno":"Assegno Unico கணக்கு","m.inps":"INPS உரிமைகள்","m.titles":"தகுதி அங்கீகாரம்","m.medical":"மருத்துவ அகராதி","m.dashboard":"என் டாஷ்போர்டு","m.tracker":"அனுமதி கண்காணிப்பு","m.docs":"ஆவண காப்பகம்","m.cvbuilder":"CV Builder",
    ...
    return '<nav class="site-nav" aria-label="Navigazione principale">'+
      ...
      '<div class="nav-collapse" id="nav-collapse">'+
        '<ul class="nav-links">'+
          ...
          navLink('community','/community','nav.community','Community',[['/community','nav.community','Community'],['/forum','m.forum','Forum'],['/opportunita','m.opportunities','Opportunità'],['/rete','f.rete','Rete & Affiliazioni'],['/chi-siamo','f.about','Chi siamo']])+
          navLink('corsi','/corsi','nav.academy','Easy Italia Academy',[['/corsi','nav.courses','Corsi'],['/academy','m.academy','Lezioni Academy'],['/certificazioni','m.certprep','Preparazione certificazioni'],['/ai-teacher','m.aiteacher','Insegnante AI'],['/esame','m.esame','Esame & Badge'],['/scuola','m.school','Scuola e studio']])+
          navLink('percorso','/percorso','nav.journey','Il Mio Percorso',[['/percorso','nav.journey','Il Mio Percorso'],['/dashboard','m.dashboard','La mia Dashboard'],['/documenti','m.docs','Archivio Documenti']])+
          ...
          navLink('servizi','/servizi','nav.services','Servizi',[['/mercatino','m.market','Mercatino'],['/cv-builder','m.cvbuilder','CV Builder'],['/permesso-tracker','m.tracker','Tracker Permesso'],['/traduci','m.translate','Traduzioni'],['/dizionario-medico','m.medical','Dizionario Medico'],['/housing','m.housing','Casa e alloggio'],['/professionisti','m.pros','Professionisti'],['/abbonamenti','f.subscriptions','Abbonamenti']])+

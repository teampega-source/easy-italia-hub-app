...
(function(){
  const I18N={
    it:{"f.langHint":"Anche l\u2019assistente AI ti risponde in italiano.", "nav.guide":"Guide","nav.community":"Community","nav.courses":"Corsi","nav.journey":"Percorso","nav.news":"News","nav.map":"Mappa","nav.contact":"Contatti","nav.login":"Accedi","nav.signup":"Registrati",
    ...
    en:{"f.langHint":"The AI assistant replies in English too.", "nav.guide":"Guides","nav.community":"Community","nav.courses":"Courses","nav.journey":"Journey","nav.news":"News","nav.map":"Map","nav.contact":"Contact","nav.login":"Log in","nav.signup":"Sign up",
    ...
    si:{"f.langHint":"AI සහායකයාද සිංහලෙන් පිළිතුරු දෙයි.", "nav.guide":"මාර්ගෝපදේශ","nav.community":"ප්‍රජාව","nav.courses":"පාඨමාලා","nav.journey":"මගේ ගමන","nav.news":"පුවත්","nav.map":"සිතියම","nav.contact":"සම්බන්ධ","nav.login":"පිවිසෙන්න","nav.signup":"ලියාපදිංචිය",
    ...
    ta:{"f.langHint":"AI உதவியாளரும் தமிழில் பதிலளிக்கும்.", "nav.guide":"வழிகாட்டிகள்","nav.community":"சமூகம்","nav.courses":"படிப்புகள்","nav.journey":"என் பயணம்","nav.news":"செய்திகள்","nav.map":"வரைபடம்","nav.contact":"தொடர்பு","nav.login":"உள்நுழைய","nav.signup":"பதிவு",
    ...
    return '<nav class="site-nav" aria-label="Navigazione principale">'+
      ...
      '<div class="nav-collapse" id="nav-collapse">'+
        '<ul class="nav-links">'+
          ...
          navLink('corsi','/corsi','nav.academy','Academy',[['/corsi','nav.courses','Corsi'],['/academy','m.academy','Lezioni Academy'],['/certificazioni','m.certprep','Preparazione certificazioni'],['/ai-teacher','m.aiteacher','Insegnante AI'],['/esame','m.esame','Esame & Badge'],['/scuola','m.school','Scuola e studio']])+
          navLink('percorso','/percorso','nav.journey','Percorso',[['/percorso','nav.journey','Il Mio Percorso'],['/dashboard','m.dashboard','La mia Dashboard'],['/documenti','m.docs','Archivio Documenti']])+
          ...
          navLink('servizi','/servizi','nav.services','Servizi',[['/mercatino','m.market','Mercatino'],['/cv-builder','m.cvbuilder','CV Builder'],['/permesso-tracker','m.tracker','Tracker Permesso'],['/traduci','m.translate','Traduzioni'],['/dizionario-medico','m.medical','Dizionario Medico'],['/housing','m.housing','Casa e alloggio'],['/professionisti','m.pros','Professionisti']])+

...
(function(){
  const I18N={
    ...
    en:{"msg.notifKo":"Notifications are not supported by this browser","msg.unavail":"Not available","msg.notifBlock":"Notifications are blocked by the browser — unblock them in the site settings","msg.remindOn":"Enable browser reminders","msg.remindOff":"Reminders are off","msg.remindOk":"✓ Reminders are on for this device","msg.netErr":"Network error. Please try again.","msg.emailNeed":"Enter your email address.","msg.readMore":"Read more","msg.readLess":"Show less","msg.delete":"Delete","f.langHint":"The AI assistant replies in English too.", "nav.guide":"Guides","nav.community":"Community","nav.courses":"Courses","nav.journey":"Journey","nav.news":"News","nav.map":"Map","nav.contact":"Contact","nav.login":"Log in","nav.signup":"Sign up",
      ...
      "nav.academy":"Academy","nav.services":"Services","m.money":"Remittance comparison","m.tpvoli":"Flights & hotels","m.fisco":"Tax and duties","m.allservices":"All services","m.forum":"Forum","m.academy":"Academy lessons","m.certprep":"Certification prep","m.aiteacher":"AI Teacher","m.school":"School & study","m.jobs":"Job board","m.market":"Marketplace","m.translate":"Translations","m.housing":"Housing","m.pros":"Professionals","m.quicknav":"Quick navigation","m.flights":"Sri Lanka Flights","m.languages":"Language Courses","m.esame":"Exam & Badge","m.opportunities":"Opportunities","m.cargo":"Cargo Shipping","m.lavdir":"Work & rights","m.duesponde":"Italy & Sri Lanka","m.costruire":"Building your future","m.templates":"Forms & Letters","m.openaccount":"Open a Bank Account","m.assegno":"Assegno Unico Calc.","m.inps":"INPS Rights Check","m.titles":"Qual. Recognition","m.medical":"Medical Dictionary","m.dashboard":"My Dashboard","m.tracker":"Permit Tracker","m.docs":"Document Archive","m.cvbuilder":"CV Builder",
    ...
    ta:{"msg.notifKo":"இந்த உலாவி அறிவிப்புகளை ஆதரிக்கவில்லை","msg.unavail":"கிடைக்கவில்லை","msg.notifBlock":"உலாவி அறிவிப்புகளைத் தடுத்துள்ளது — தள அமைப்புகளில் அனுமதியுங்கள்","msg.remindOn":"உலாவி நினைவூட்டல்களை இயக்குங்கள்","msg.remindOff":"நினைவூட்டல்கள் இயக்கத்தில் இல்லை","msg.remindOk":"✓ இந்தச் சாதனத்தில் நினைவூட்டல்கள் இயக்கத்தில் உள்ளன","msg.netErr":"பிணைப் பிழை. மீண்டும் முயலுங்கள்.","msg.emailNeed":"உங்கள் மின்னஞ்சலை உள்ளிடுங்கள்.","msg.readMore":"மேலும் படிக்க","msg.readLess":"குறைவாகக் காட்டு","msg.delete":"நீக்கு","f.langHint":"AI உதவியாளரும் தமிழில் பதிலளிக்கும்.", "nav.guide":"வழிகாட்டிகள்","nav.community":"சமூகம்","nav.courses":"படிப்புகள்","nav.journey":"என் பயணம்","nav.news":"செய்திகள்","nav.map":"வரைபடம்","nav.contact":"தொடர்பு","nav.login":"உள்நுழைய","nav.signup":"பதிவு",
      ...
      "nav.academy":"அகாடமி","nav.services":"சேவைகள்","m.money":"பணப் பரிமாற்ற ஒப்பீடு","m.tpvoli":"விமானங்கள் & ஹோட்டல்கள்","m.fisco":"வரி மற்றும் தீர்வை","m.allservices":"அனைத்துச் சேவைகளும்","m.forum":"மன்றம்","m.academy":"Academy பாடங்கள்","m.certprep":"சான்றிதழ் தயாரிப்பு","m.aiteacher":"AI ஆசிரியர்","m.school":"பள்ளி & படிப்பு","m.jobs":"வேலை பலகை","m.market":"சந்தை","m.translate":"மொழிபெயர்ப்புகள்","m.housing":"வீடு","m.pros":"நிபுணர்கள்","m.quicknav":"விரைவு வழிசெலுத்தல்","m.flights":"இலங்கை விமானங்கள்","m.languages":"மொழி வகுப்புகள்","m.esame":"தேர்வு & பேட்ஜ்","m.opportunities":"வாய்ப்புகள்","m.cargo":"சரக்கு அனுப்புதல்","m.lavdir":"வேலை மற்றும் உரிமைகள்","m.duesponde":"இத்தாலி மற்றும் இலங்கை","m.costruire":"எதிர்காலத்தை கட்டமைத்தல்","m.templates":"படிவங்கள் & கடிதங்கள்","m.openaccount":"வங்கி கணக்கு திறக்க","m.assegno":"Assegno Unico கணக்கு","m.inps":"INPS உரிமைகள்","m.titles":"தகுதி அங்கீகாரம்","m.medical":"மருத்துவ அகராதி","m.dashboard":"என் டாஷ்போர்டு","m.tracker":"அனுமதி கண்காணிப்பு","m.docs":"ஆவண காப்பகம்","m.cvbuilder":"CV உருவாக்கி",
    ...
    return '<nav class="site-nav" aria-label="Navigazione principale">'+
      ...
      '<div class="nav-collapse" id="nav-collapse">'+
        '<ul class="nav-links">'+
          ...
          navLink(['servizi','permesso-tracker','documenti','cv-builder','money-transfer','wise','travelpayouts','fisco','traduci','opportunita','housing','lavoro','mercatino','professionisti'],'/servizi','nav.services','Servizi',[
  ...
  /* Da telefono la presentazione di pagina si mangiava mezzo schermo prima
     dello strumento. Restano tre righe e il resto si apre al tocco: niente
     testo tolto, solo rimandato. Solo la frase d'apertura, non i sommari
     che stanno in mezzo alla pagina. */
  var _leadBtn=null;
  function accorciaLead(){
    if(!matchMedia('(max-width:640px)').matches)return;
    var p=document.querySelector('main .lead');
    if(!p||p.dataset.leadCorto)return;
    p.classList.add('lead-corto');
    if(p.scrollHeight<=p.clientHeight+2){p.classList.remove('lead-corto');return;}
    p.dataset.leadCorto='1';
    var b=document.createElement('button');
    b.type='button';b.className='lead-piu';b.setAttribute('aria-expanded','false');
    b.textContent=EIH.msg('msg.readMore','Leggi tutto');
    b.addEventListener('click',function(){
      var chiuso=p.classList.toggle('lead-corto');
      b.setAttribute('aria-expanded',chiuso?'false':'true');
      b.textContent=chiuso?EIH.msg('msg.readMore','Leggi tutto'):EIH.msg('msg.readLess','Mostra meno');
    });
    p.insertAdjacentElement('afterend',b);
    _leadBtn=b;
  }
  function rietichettaLead(){
    if(!_leadBtn)return;
    _leadBtn.textContent=_leadBtn.getAttribute('aria-expanded')==='true'
      ?EIH.msg('msg.readLess','Mostra meno'):EIH.msg('msg.readMore','Leggi tutto');
  }
  window.addEventListener('eihLangChanged',rietichettaLead);
  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',accorciaLead,{once:true});
  else setTimeout(accorciaLead,0);   // EIH.msg si definisce piu' in basso
  ...
  const BREADCRUMBS={
    ...
    'travelpayouts':[['Voli','/voli','m.flights'],['Travelpayouts','/travelpayouts','',true]],

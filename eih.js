    ...
    return '<nav class="site-nav" aria-label="Navigazione principale">'+
      ...
      '<div class="nav-collapse" id="nav-collapse">'+
        '<ul class="nav-links">'+
          ...
          navLink(['servizi','permesso-tracker','documenti','cv-builder','money-transfer','wise','travelpayouts','fisco','traduci','opportunita','housing','mercatino','professionisti'],'/servizi','nav.services','Servizi',[

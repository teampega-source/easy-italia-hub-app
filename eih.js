...
(function(){
  ...
  if(!window.__eih3d&&document.querySelector('[data-eih-hero3d]')){var _td=document.createElement('script');_td.src='/assets/eih-3d.js';_td.defer=true;document.head.appendChild(_td);}
})();
